...
public class DateTime implements org.apache.thrift.TBase<DateTime, DateTime._Fields>, java.io.Serializable, Cloneable, Comparable<DateTime> {
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DateTimeStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DateTimeTupleSchemeFactory();
    ...
    public DateTime setMonth(short month) {
        this.month = month;
        setMonthIsSet(true);
        return this;
    }
    ...
    public DateTime setDay(short day) {
        this.day = day;
        setDayIsSet(true);
        return this;
    }
    ...
    public DateTime setMinute(short minute) {
        this.minute = minute;
        setMinuteIsSet(true);
        return this;
    }
    ...
    public DateTime setSecond(short second) {
        this.second = second;
        setSecondIsSet(true);
        return this;
    }
        ...
        switch (field) {
            ...
            case MINUTE:
                if (value == null) {
                    ...
                    setMinute((java.lang.Short) value);
                }
                break;
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder sb = new java.lang.StringBuilder("DateTime(");
        boolean first = true;
    ...
    public void validate() throws org.apache.thrift.TException {
        ...
        // alas, we cannot check 'second' because it's a primitive and you chose the non-beans generator.
    ...
    private static class DateTimeStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
        public DateTimeStandardScheme getScheme() {
            return new DateTimeStandardScheme();
        }
    }

    private static class DateTimeStandardScheme extends org.apache.thrift.scheme.StandardScheme<DateTime> {
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot, DateTime struct) throws org.apache.thrift.TException {
            ...
            if (!struct.isSetSecond()) {
                throw new org.apache.thrift.protocol.TProtocolException("Required field 'second' was not found in serialized data! Struct: " + toString());
            }
            struct.validate();
        }
    ...
    private static class DateTimeTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
        public DateTimeTupleScheme getScheme() {
            return new DateTimeTupleScheme();
        }
    }

    private static class DateTimeTupleScheme extends org.apache.thrift.scheme.TupleScheme<DateTime> {
